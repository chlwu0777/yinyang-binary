              ...
              {isWin ? (
                <>
                  ...
                  {level < puzzles.length ? (
                    <button type="button" onMouseDown={(e) => { e.preventDefault(); resetGame('puzzle', level + 1); }} style={{ padding: '10px 28px', borderRadius: 10, background: '#fff', color: '#050508', border: 'none', cursor: 'pointer', fontSize: 15 }}>下一关 Next →</button>
                  ) : (
